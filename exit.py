...
class Ui_Exit_Form(object):
    ...
    def retranslateUi(self, Exit_Form):
        ...
        self.label.setText(_translate("Exit_Form", "Вы точно хотите закрыть программу?"))
        self.pushButton_exitprog.setText(_translate("Exit_Form", "Закрыть"))
        self.pushButton_auth.setText(_translate("Exit_Form", "Вернуться"))
